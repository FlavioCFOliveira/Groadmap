		...
		Subcommands: []Subcommand{
			{
				...
				ExitCodes: []ExitCodeEntry{
					ec(0, "The roadmap's sprints were written to stdout as a JSON array, ordered by sprint order ascending; an empty array when the filter matches none."),
					ec(2,
						condUnknownFlag,
					...
					ec(6, "--status carries a value that is not a member of SprintStatus."),
				},
				Examples: []Example{
			...
			},
			{
				...
				Prerequisites: []string{
					"When --order is supplied, no other sprint of the roadmap already uses that order value.",
				},
				ExitCodes: []ExitCodeEntry{
					ec(0, "The sprint was created in PENDING status and its id was written to stdout."),
					ec(2,
						"--title or --description was omitted, or supplied with the literal empty string.",
						"--max-tasks carries a value that is not an integer.",
						"An unrecognised flag was supplied.",
						"A positional argument was supplied; this subcommand declares an arity of zero.",
					),
					ec(3, condNoRoadmap),
					ec(4, condRoadmapNotFound),
					ec(5, "Another sprint of the roadmap already uses the --order value supplied."),
					ec(6,
						"--title or --description is empty once trimmed, exceeds its cap, is not valid UTF-8, or carries a control character.",
						"--max-tasks falls outside 1-10000.",
						"--order is not a positive integer greater than zero.",
					),
				},
				Examples: []Example{
			...
			},
			{
				...
				ExitCodes: []ExitCodeEntry{
					...
					ec(4,
						condRoadmapNotFound,
						"The named sprint does not exist.",
					),
				},
				Examples: []Example{
			...
			},
			{
				...
				Prerequisites: []string{
					"The sprint named on the command line exists.",
					"--order is accepted only while the sprint is PENDING or OPEN; once the sprint is CLOSED its order is immutable.",
					"When --order is supplied, no other sprint of the roadmap already uses that order value.",
				},
				ExitCodes: []ExitCodeEntry{
					ec(0, "Every supplied field was written to the sprint; stdout is empty."),
					ec(2,
						"--max-tasks carries a value that is not an integer.",
						"An unrecognised flag was supplied, or a flag was written with no value after it.",
					...
					ec(6,
						...
						"--max-tasks falls outside 1-10000.",
						"--order is not a positive integer greater than zero.",
						"--order was supplied for a sprint that is CLOSED.",
					),
				},
				Examples: []Example{
			...
			},
			{
				...
				Prerequisites: []string{
					"The sprint named on the command line exists.",
					"The sprint is in PENDING status.",
					"No other sprint of the roadmap is OPEN; only one sprint can be OPEN at a time.",
				},
				ExitCodes: []ExitCodeEntry{
					...
					ec(6,
						"The sprint is not in PENDING status.",
						"Another sprint of the roadmap is already OPEN.",
					),
				},
				Examples: []Example{
			...
			},
			{
				...
				Prerequisites: []string{
					"The sprint named on the command line exists.",
					"The sprint is in OPEN status.",
					"No task of the sprint is still in SPRINT, DOING or TESTING, unless --force is supplied.",
				},
				ExitCodes: []ExitCodeEntry{
					...
					ec(6,
						"The sprint is not in OPEN status.",
						"Tasks of the sprint are still in SPRINT, DOING or TESTING and --force was not supplied.",
					),
				},
				Examples: []Example{
			...
			},
			{
				...
				Prerequisites: []string{
					"The sprint named on the command line exists.",
					"The sprint is in CLOSED status.",
					"No other sprint of the roadmap is OPEN.",
				},
				ExitCodes: []ExitCodeEntry{
					...
					ec(6,
						"The sprint is not in CLOSED status.",
						"Another sprint of the roadmap is already OPEN.",
					),
				},
				Examples: []Example{
			...
			},
			{
				...
				ExitCodes: []ExitCodeEntry{
					ec(0, "The sprint's tasks were written to stdout as a JSON array; an empty array when the sprint holds no task of the requested status."),
					ec(2,
						condUnknownFlag,
						condFlagWithoutValue,
						condMalformedPositionalID,
					...
					ec(6, "--status carries a value that is not a member of TaskStatus."),
				},
				Examples: []Example{
			...
			},
			{
				...
				ExitCodes: []ExitCodeEntry{
					ec(0, "The sprint's SPRINT, DOING and TESTING tasks were written to stdout as a JSON array; an empty array when none remains."),
					ec(2,
						condUnknownFlag,
						condMalformedPositionalID,
						condMissingPositional,
			...
			},
			{
				...
				ExitCodes: []ExitCodeEntry{
					...
					ec(4,
						condRoadmapNotFound,
						"The named sprint does not exist.",
						"At least one task id names no task; nothing is changed.",
					),
					ec(6,
			...
			},
			{
				...
				ExitCodes: []ExitCodeEntry{
					...
					ec(6, "At least one named task is not a member of the sprint; nothing is changed."),
				},
				Examples: []Example{
			...
			},
			{
				...
				ExitCodes: []ExitCodeEntry{
					...
					ec(4,
						condRoadmapNotFound,
						"The source sprint does not exist.",
						"The destination sprint does not exist.",
					),
					ec(6, "At least one named task is not a member of the source sprint; nothing is changed."),
				},
				Examples: []Example{
			...
			},
			{
				...
				Flags: []Flag{sharedRoadmapFlag(), helpFlag()},
				// This subcommand is the one of the five ordering commands that
				// writes a body. It declared `empty` and printed the object
				// below, so an agent reading the contract was told to expect
				// nothing on a command that answers, which is the shape the
				// gate over the published examples caught
				// (SPEC/COMMANDS.md § Reorder Tasks (Set Exact Order) is
				...
				Prerequisites: []string{
					"The sprint named on the command line exists.",
					"The id list names every member of the sprint, each exactly once; read the current membership with `sprint tasks` first.",
				},
				ExitCodes: []ExitCodeEntry{
					...
					ec(6,
						"An id in the list is not a member of the sprint.",
						"An id appears more than once in the list.",
						"The list does not name every member of the sprint.",
					),
				},
				Examples: []Example{
			...
			},
			{
				...
				Flags: []Flag{sharedRoadmapFlag(), helpFlag()},
				// The five ordering commands all write a JSON success object; the
				// registry declared `empty` for every one of them, so the contract
				// told an agent to expect nothing on a command that answers. Measured
				// against the compiled binary by the gate over the published examples
				...
				Prerequisites: []string{
					"The sprint named on the command line exists.",
					"The task named on the command line is a member of that sprint.",
				},
				ExitCodes: []ExitCodeEntry{
					...
					ec(6,
						"The named task is not a member of the sprint.",
						"The position falls outside 0-2147483647.",
					),
				},
				Examples: []Example{
			...
			},
			{
				...
				Prerequisites: []string{
					"The sprint named on the command line exists.",
					"Both tasks named on the command line are members of that sprint.",
				},
				ExitCodes: []ExitCodeEntry{
					...
					ec(6,
						"A named task is not a member of the sprint.",
						"The same task id was given twice.",
					),
				},
				Examples: []Example{
			...
			},
			{
				...
				ExitCodes: []ExitCodeEntry{
					...
					ec(6, "The named task is not a member of the sprint."),
				},
				Examples: []Example{
...
func sprintCommentAddSubcommand() Subcommand {
	return Subcommand{
		...
		ExitCodes: []ExitCodeEntry{
			ec(0, "The comment was stored against the sprint and its own id was written to stdout."),
			ec(1,
				"The body was to be read from standard input and the read of the stream failed.",
				"The roadmap database could not be read or written.",
			),
			ec(2,
				"--type was omitted.",
				"No body was supplied: --body is absent and standard input is empty, whitespace only, or a terminal.",
				"The sprint id was omitted, is not an integer, or falls outside 1-2147483647.",
			...
			ec(6,
				"--type carries a value that is not a member of SprintCommentType; the task-only values HYPOTHESIS, TEST and NOTE are refused here.",
				"The body exceeds 4096 characters, is not valid UTF-8, or carries a control character.",
			),
		},
		Examples: []Example{
			{
...
func sprintCommentListSubcommand() Subcommand {
	return Subcommand{
		...
		ExitCodes: []ExitCodeEntry{
			ec(0, "The sprint's comments were written to stdout as a JSON array, oldest first; an empty array when it has none of the requested type."),
			ec(2,
				"The sprint id was omitted, is not an integer, or falls outside 1-2147483647.",
				"A second positional argument was supplied, or an unrecognised flag was supplied.",
			),
			...
			ec(6, "--type carries a value that is not a member of SprintCommentType."),
		},
		Examples: []Example{
...
func sprintCommentEditSubcommand() Subcommand {
	return Subcommand{
		...
		Idempotent:  true,
		Prerequisites: []string{
			"A sprint comment carries the id named on the command line; it is the comment's own id, not the sprint's.",
		},
		ExitCodes: []ExitCodeEntry{
			...
			ec(4,
				condRoadmapNotFound,
				"No sprint comment carries the named id.",
			),
			ec(6,
				"--type carries a value that is not a member of SprintCommentType.",
				"The new body exceeds 4096 characters, is not valid UTF-8, or carries a control character.",
			),
		},
		Examples: []Example{
...
func sprintCommentRemoveSubcommand() Subcommand {
	return Subcommand{
		...
		ExitCodes: []ExitCodeEntry{
			ec(0, "The comment row was deleted; stdout is empty."),
			ec(1, "The roadmap database could not be read or written."),
			ec(2,
				"The comment id was omitted, is not an integer, or falls outside 1-2147483647.",
				"A second positional argument was supplied, or an unrecognised flag was supplied.",
			),
