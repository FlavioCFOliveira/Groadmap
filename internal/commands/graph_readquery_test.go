// Package commands — tests for readQuery, the argument parser shared by every
// rmp graph subcommand. The graph store lock these subcommands take is no
// longer implemented here: it is internal/graphlock, tested in that package.
package commands
