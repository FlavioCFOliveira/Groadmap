...
func TestTaskValidate(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "empty functional_requirements",
			task: Task{
				Priority:               5,
				Severity:               3,
				Status:                 StatusBacklog,
			...
			wantErr: true,
			errMsg:  "functional_requirements is required",
		},
		{
			name: "empty technical_requirements",
			task: Task{
				Priority:               5,
				Severity:               3,
				Status:                 StatusBacklog,
			...
			wantErr: true,
			errMsg:  "technical_requirements is required",
		},
		{
			name: "empty acceptance_criteria",
			task: Task{
				Priority:               5,
				Severity:               3,
				Status:                 StatusBacklog,
			...
			wantErr: true,
			errMsg:  "acceptance_criteria is required",
		},
		{
		...
		},
		{
			...
			task: Task{
				...
				Severity:               3,
				Status:                 StatusBacklog,
				Title:                  strings.Repeat("a", MaxTaskTitle+1),
				FunctionalRequirements: "Test functional requirements",
				TechnicalRequirements:  "Test technical requirements",
				AcceptanceCriteria:     "Test acceptance criteria",
				CreatedAt:              validCreatedAt,
		...
		{
			name: "functional_requirements too long",
			task: Task{
				Priority:               5,
				Severity:               3,
				Status:                 StatusBacklog,
				Title:                  "Test title",
				FunctionalRequirements: strings.Repeat("a", MaxTaskFunctionalRequirements+1),
				TechnicalRequirements:  "Test technical requirements",
				AcceptanceCriteria:     "Test acceptance criteria",
				CreatedAt:              validCreatedAt,
			},
			wantErr: true,
			errMsg:  "functional_requirements exceeds maximum length",
		},
		{
			name: "technical_requirements too long",
			task: Task{
				Priority:               5,
				Severity:               3,
				Status:                 StatusBacklog,
				Title:                  "Test title",
				FunctionalRequirements: "Test functional requirements",
				TechnicalRequirements:  strings.Repeat("a", MaxTaskTechnicalRequirements+1),
				AcceptanceCriteria:     "Test acceptance criteria",
				CreatedAt:              validCreatedAt,
			},
			wantErr: true,
			errMsg:  "technical_requirements exceeds maximum length",
		},
		{
			name: "acceptance_criteria too long",
			task: Task{
				Priority:               5,
				Severity:               3,
				Status:                 StatusBacklog,
				...
				FunctionalRequirements: "Test functional requirements",
				TechnicalRequirements:  "Test technical requirements",
				AcceptanceCriteria:     strings.Repeat("a", MaxTaskAcceptanceCriteria+1),
				CreatedAt:              validCreatedAt,
			},
			wantErr: true,
		...
		{
			name: "closed_at before created_at",
			task: Task{
				Priority:               5,
				Severity:               3,
				Status:                 StatusCompleted,
				...
				ClosedAt:               func() *string { s := "2026-03-15T12:00:00.000Z"; return &s }(),
			},
			wantErr: true,
		...
		},
		{
			...
			task: Task{
				...
				AcceptanceCriteria:     "Test acceptance criteria",
				CreatedAt:              validCreatedAt,
				ClosedAt:               func() *string { s := "invalid-date"; return &s }(),
			},
			wantErr: true,
			errMsg:  "invalid closed_at",
		},
	}
...
func TestTaskValidateDates(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name: "valid dates - closed after created",
			task: Task{
				Priority:               5,
				Severity:               3,
				Status:                 StatusCompleted,
				Title:                  "Test",
				FunctionalRequirements: "Test",
				TechnicalRequirements:  "Test",
				AcceptanceCriteria:     "Test",
				CreatedAt:              "2026-03-16T10:00:00.000Z",
				ClosedAt:               func() *string { s := "2026-03-16T12:00:00.000Z"; return &s }(),
			},
			wantErr: false,
		},
		{
		...
		{
			name: "invalid - closed_at before created_at",
			task: Task{
				Priority:               5,
				Severity:               3,
				Status:                 StatusCompleted,
				...
				AcceptanceCriteria:     "Test",
				CreatedAt:              "2026-03-16T12:00:00.000Z",
				ClosedAt:               func() *string { s := "2026-03-16T10:00:00.000Z"; return &s }(),
			},
			wantErr: true,
		},
	}
...
func TestTaskFieldLimits(t *testing.T) {
	...
	if MaxTaskTitle <= 0 {
		t.Error("MaxTaskTitle should be positive")
	}
	if MaxTaskFunctionalRequirements <= 0 {
		t.Error("MaxTaskFunctionalRequirements should be positive")
	}
	if MaxTaskTechnicalRequirements <= 0 {
		t.Error("MaxTaskTechnicalRequirements should be positive")
	}
