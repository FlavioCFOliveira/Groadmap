...
|--------|------|---------|---------|
| GoGraph | `github.com/FlavioCFOliveira/GoGraph` | Exact tag **v0.2.0** | Labelled property graph, Cypher engine, and durable store backing the `graph` command. See `GRAPH.md`. |
...
2. GoGraph is consumed at the exact tag **v0.2.0**. Because v0.2.0 is a v0 (pre-1.0)
   ...
   `v0.2.0`. This exact-tag pin satisfies Rule 1.
3. v0.2.0 is a `0.y.z` release, so GoGraph's public API is not yet stable and may
